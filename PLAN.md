...
- **PR #3630**: open as draft against `staging`, **422 files** as of 2026-05-17 Codex re-audit (was 396; staging diverged further with merged PRs landing in parallel). **Mergeable state: DIRTY (CONFLICTING).** Agent-opened 2026-05-15T22:35:41Z (see §"Execution log" → "2026-05-15 night — branch reorg" for context). Per user direction "do nothing with it right now." Codex's view: leave draft/dirty until SRS wiring (W1 Phase 2+) and Docker (W2) lands — premature merge attempts will just churn.
...
- **cur8-api PR #3630**: 396 → **422** changed files (staging diverged further). State: still DIRTY (CONFLICTING). Hold per existing decision until SRS wiring + Docker ready.
