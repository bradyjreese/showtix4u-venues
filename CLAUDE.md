...
- **pnpm** via corepack — Prettier for formatting and TypeScript for builder checks
...
- S3 auth: use `AWS_PROFILE=cur8-prod aws ...` directly; credentials come
  from 1Password-backed `credential_process`
